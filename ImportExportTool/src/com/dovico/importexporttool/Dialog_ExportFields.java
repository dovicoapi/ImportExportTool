...
public class Dialog_ExportFields extends JDialog {
	...
	public void setDataSourceAndSelectedFields(String sSelectedDataSource, Object[] arrSelectedFieldValues) {
		...
		CResourceHelper.getAPIFieldsForResource(sSelectedDataSource, true, alAvailableFields);
