...
// This comes in handy from time-to-time so I'm leaving it here for debugging purposes.
...
//catch (IOException e) {} 
//finally {
//	try { if(fwWriter!=null){ fwWriter.flush(); fwWriter.close(); } } catch (IOException e) {}
//}
