...
public class CDatePicker {
    ...
    public Date getSelectedDate() {
	    ...
	    // Create a Calendar object for the current year, month, and selected day and then return the Date object to the caller 
	    Calendar calSelectedDay = Calendar.getInstance();
	    calSelectedDay.set(m_iYear, m_iMonth, Integer.parseInt(m_sSelectedDay));
